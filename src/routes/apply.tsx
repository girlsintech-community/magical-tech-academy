    ...
    <>
      ...
      <main className="relative z-10 mx-auto max-w-4xl px-6 pt-32 pb-24">
        ...
        <div className="mt-8 text-center">
           <p className="text-xs font-semibold uppercase tracking-[0.4em] text-gold">Student applications</p>
          ...
          <p className="mx-auto mt-4 max-w-xl text-sm text-foreground/75 sm:text-base">
             Applications closed on 14 June 2026. The application parchment remains available in its own portal.
          </p>
        </div>
        <div className="mt-12 text-center">
          <Button asChild size="lg" className="rounded-full bg-gradient-to-r from-[color:var(--gold)] to-[color:var(--ember)] px-8 shadow-[var(--shadow-glow)]">
            ...
            >
              View student application <ExternalLink className="h-4 w-4" />
            </a>
          </Button>
        </div>
      </main>
